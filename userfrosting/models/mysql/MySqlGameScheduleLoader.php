...
class MySqlGameScheduleLoader extends MySqlObjectLoader implements GameScheduleLoaderInterface{
    ...
    public static function init(){
        ...
        static::$_table = static::getTableGameSchedule();
        static::$_columns = static::$columns_gameschedule;
    }
    ...
    */
    public static function fetch($value, $name = "id"){
        ...
        if ($results)
            return new GameSchedule($results, $results['id']);
        else
            return false;
    }
    ...
    */
    public static function fetchAll($value = null, $name = null){
        ...
        $results = [];
        foreach ($resultArr as $id => $game)
            $results[$id] = new GameSchedule($game, $id);
