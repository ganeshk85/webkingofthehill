...
class MySqlGameWeekLoader extends MySqlObjectLoader{
    ...
    public static function init(){
        ...
        static::$_table = static::getTableWeeks();
        static::$_columns = static::$columns_weeks;
    }
    ...
    */
    public static function fetch($value, $name = "id"){
        ...
        if ($results)
            return new GameWeek($results, $results['id']);
        else
            return false;
    }
    ...
    */
    public static function fetchAll($value = null, $name = null){
        ...
        foreach ($resultArr as $id => $team)
            $results[$id] = new GameWeek($team, $id);
