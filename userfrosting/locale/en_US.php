...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_WELCOME" => "Welcome back, {{display_name}}",
        "ACCOUNT_PLAYERS_EXIST" => "There are Players associated with this account, please delete the players first."
));

//Player
$lang = array_merge($lang,array(
	"PLAYER_SPECIFY_PLAYERNAME" 		=> "Please enter your player name.",
	"PLAYER_CHAR_LIMIT" => "Your playername must be between {{min}} and {{max}} characters in length.",
	"PLAYER_PLAYERNAME_IN_USE"		=> "Playername '{{player_name}}' is already in use",
	"PLAYER_CREATION_COMPLETE"		=> "'{{player_name}}' has been created.",
	"PLAYER_DETAILS_UPDATED"		=> "Player details updated for player '{{player_name}}'",
	"PLAYER_DISABLE_SUCCESSFUL"     => "'{{player_name}}' has been successfully disabled.",
    "PLAYER_ENABLE_SUCCESSFUL"     => "'{{player_name}}' has been successfully enabled.",
    "PLAYER_DELETION_SUCCESSFUL"		=> "'{{player_name}}' has been successfully deleted.",
	"PLAYER_MANUALLY_ACTIVATED"		=> "{{player_name}} has been manually activated",
	"PLAYER_PICKED_COMPLETE"		=> "Player has successfully picked a team.",
	"PLAYER_PICKED_UPDATED"		=> "Team Successfully updated.",
	"PLAYER_PICKED_IN_USE" => "Cannot pick the Team already picked in previous weeks",
	"PLAYER_PICKED_DELETION_SUCCESSFUL" => "Pick has been successfully deleted.",
	"PLAYER_CANNOT_PICK" => "You cannot make a Pick after 1PM on Game Date.",
        "PLAYER_CLEAR_PAYMENT_FIRST" => "Please clear the payment dues associated with the user account, then try again to delete the player"
));


//Payment
$lang = array_merge($lang,array(
	"PAYMENT_SPECIFY_AMOUNT" 		=> "Please enter payment amount",
	"PAYMENT_AMOUNT_SHOULD_NUMBER" => "Payment Amount should only contain numbers.",	
        "PAYMENT_UPDATED_SUCCESS" 		=> "Payment Added Successfully",    
    "PAYMENT_AMOUNT_ZERO" 		=> "Payment Amount cannot be less than 0",    
    "PAYMENT_AMOUNT_MORE_AMOUNT_DUE" 		=> "Payment Amount is more than the Amount Due",    
    "PAYMENT_PLAYERS_ACTIVE" 		=> "All Players are now Activated",
